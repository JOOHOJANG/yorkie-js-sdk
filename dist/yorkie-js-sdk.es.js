...
const ValueType = /* @__PURE__ */ proto3.makeEnum(
  "yorkie.v1.ValueType",
  [
...
const DocEventType$1 = /* @__PURE__ */ proto3.makeEnum(
...
const Snapshot = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.Snapshot",
  () => [
...
const ChangePack$1 = /* @__PURE__ */ proto3.makeMessageType(
  ...
  () => [
    ...
    { no: 7, name: "snapshot_version_vector", kind: "message", T: VersionVector$1 },
...
const Change$1 = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.Change",
  () => [
...
const ChangeID$1 = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.ChangeID",
  () => [
    {
      no: 1,
...
const VersionVector$1 = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation$1 = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.Operation",
  () => [
...
const Operation_Set = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Add = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Move = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Remove = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Edit = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Select = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Style = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_Increase = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_TreeEdit = /* @__PURE__ */ proto3.makeMessageType(
...
const Operation_TreeStyle = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElementSimple = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_JSONObject = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_JSONArray = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_Primitive = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_Text = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_Counter = /* @__PURE__ */ proto3.makeMessageType(
...
const JSONElement_Tree = /* @__PURE__ */ proto3.makeMessageType(
...
const RHTNode$1 = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.RHTNode",
  () => [
    {
      no: 1,
...
const RGANode = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.RGANode",
  () => [
...
const NodeAttr = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.NodeAttr",
  () => [
    {
      no: 1,
...
const TextNode = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.TextNode",
  () => [
...
const TextNodeID = /* @__PURE__ */ proto3.makeMessageType(
...
const TreeNode = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.TreeNode",
  () => [
...
const TreeNodes = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.TreeNodes",
  () => [
    { no: 1, name: "content", kind: "message", T: TreeNode, repeated: true }
  ]
);
const TreeNodeID = /* @__PURE__ */ proto3.makeMessageType(
...
const TreePos = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.TreePos",
  () => [
...
const PresenceChange = /* @__PURE__ */ proto3.makeMessageType(
...
const PresenceChange_ChangeType = /* @__PURE__ */ proto3.makeEnum(
...
const Presence$1 = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.Presence",
  () => [
...
const Checkpoint$1 = /* @__PURE__ */ proto3.makeMessageType(
...
const TextNodePos = /* @__PURE__ */ proto3.makeMessageType(
...
const TimeTicket$1 = /* @__PURE__ */ proto3.makeMessageType(
...
const DocEventBody = /* @__PURE__ */ proto3.makeMessageType(
...
const DocEvent = /* @__PURE__ */ proto3.makeMessageType(
  "yorkie.v1.DocEvent",
  () => [
...
class ChangeID {
   ...
   */
  syncClocks(other) {
    const lamport = other.lamport.greaterThan(this.lamport) ? other.lamport : this.lamport.add(1);
  ...
  setClocks(otherLamport, vector) {
    const lamport = otherLamport.greaterThan(this.lamport) ? otherLamport : this.lamport.add(1);
...
class ChangePack {
  constructor(key, checkpoint, isRemoved, changes, snapshot, snapshotVersionVector, minSyncedTicket) {
    /**
     ...
     */
    __publicField(this, "snapshotVersionVector");
    /**
   ...
   */
  static create(key, checkpoint, isRemoved, changes, snapshot, snapshotVersionVector, minSyncedTicket) {
...
class Document {
   ...
   */
  applySnapshot(serverSeq, snapshot, snapshotVector) {
