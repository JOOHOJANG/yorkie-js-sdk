...
declare class ChangeID {
    ...
    constructor(clientSeq: number, lamport: default_2, actor: ActorID, vector: VersionVector, serverSeq?: default_2);
    /**
     * `of` creates a new instance of ChangeID.
     */
    static of(clientSeq: number, lamport: default_2, actor: ActorID, vector: VersionVector, serverSeq?: default_2): ChangeID;
    /**
     ...
     */
    setClocks(otherLamport: default_2, vector: VersionVector): ChangeID;
    /**
...
declare class ChangePack<P extends Indexable> {
    ...
    constructor(key: string, checkpoint: Checkpoint, isRemoved: boolean, changes: Array<Change<P>>, snapshot?: Uint8Array, snapshotVersionVector?: VersionVector, minSyncedTicket?: TimeTicket);
    /**
     * `create` creates a new instance of ChangePack.
     */
    static create<P extends Indexable>(key: string, checkpoint: Checkpoint, isRemoved: boolean, changes: Array<Change<P>>, snapshot?: Uint8Array, snapshotVersionVector?: VersionVector, minSyncedTicket?: TimeTicket): ChangePack<P>;
    /**
     ...
     */
    getSnapshotVersionVector(): VersionVector | undefined;
    /**
...
declare class ChangePack_2 extends Message<ChangePack_2> {
     ...
     */
    snapshotVersionVector?: VersionVector_2;
...
declare class Document_2<T, P extends Indexable = Indexable> {
     ...
     */
    applySnapshot(serverSeq: default_2, snapshot: Uint8Array, snapshotVector: VersionVector): void;
    /**
