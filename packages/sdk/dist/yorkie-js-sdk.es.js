...
let Operation$1 = (_d = class extends Message {
  constructor(data) {
    super();
    /**
...
}, __publicField(_d, "runtime", proto3), __publicField(_d, "typeName", "yorkie.v1.Operation"), __publicField(_d, "fields", proto3.util.newFieldList(() => [
...
let RHTNode$1 = (_e = class extends Message {
  constructor(data) {
    super();
    /**
...
}, __publicField(_e, "runtime", proto3), __publicField(_e, "typeName", "yorkie.v1.RHTNode"), __publicField(_e, "fields", proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "key",
    kind: "scalar",
...
let Presence$1 = (_f = class extends Message {
  constructor(data) {
    super();
    /**
...
}, __publicField(_f, "runtime", proto3), __publicField(_f, "typeName", "yorkie.v1.Presence"), __publicField(_f, "fields", proto3.util.newFieldList(() => [
...
}, __publicField(_g, "runtime", proto3), __publicField(_g, "typeName", "yorkie.v1.Checkpoint"), __publicField(_g, "fields", proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "server_seq",
    kind: "scalar",
...
let TimeTicket$1 = (_h = class extends Message {
  constructor(data) {
    super();
    /**
...
}, __publicField(_h, "runtime", proto3), __publicField(_h, "typeName", "yorkie.v1.TimeTicket"), __publicField(_h, "fields", proto3.util.newFieldList(() => [
  {
    no: 1,
    name: "lamport",
    kind: "scalar",
...
class IndexTree {
   ...
   *
   */
  findLeafPathOfSubTree(subTreePath = []) {
    let root = this.root;
    let index = 0;
...
class CRDTTree extends CRDTElement {
   ...
   *
   */
  findLeafPathOfSubTree(parentPath) {
...
const InitialChangeID = new ChangeID(0, 0n, InitialActorID);
class Change {
  constructor({
    id,
    operations,
...
class Tree {
   ...
   *
   */
  findLeafPathOfSubTree(path) {
    var _a2;
    return (_a2 = this.tree) == null ? void 0 : _a2.findLeafPathOfSubTree(path);
  }
}
...
class AIWriter {
  constructor(apiKey, docKey, host) {
    ...
    __publicField(this, "_messages", [
      {
        role: "system",
        content: "모든 대답은 한국어로, 최소한 3개의 문단을 포함해야하며, 가능한 길게 대답해야해"
      }
    ]);
 ...
 ${context}`
    ...
    const lines = content.split("\n").flatMap((line) => {
      ...
      while (index2 < line.length) {
        arr.push(line.slice(index2, index2 + 3));
        index2 += 3;
      }
      return arr;
    });
