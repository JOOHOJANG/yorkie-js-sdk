...
declare class ChangeID {
    ...
    private lamport;
    private actor;
    constructor(clientSeq: number, lamport: bigint, actor: ActorID, serverSeq?: bigint);
    /**
     * `of` creates a new instance of ChangeID.
     */
    static of(clientSeq: number, lamport: bigint, actor: ActorID, serverSeq?: bigint): ChangeID;
    /**
     ...
     */
    syncLamport(otherLamport: bigint): ChangeID;
    /**
...
export declare class Client {
     ...
     */
    broadcast(docKey: DocumentKey, topic: string, payload: Json, options?: BroadcastOptions): Promise<void>;
    /**
...
declare class CRDTTree extends CRDTElement implements GCParent {
     ...
     *
     */
    findLeafPathOfSubTree(parentPath: Array<number>): number[];
}
 ...
 * @public
 */
export declare type DocEvent<P extends Indexable = Indexable, T = OperationInfo> = StatusChangedEvent | ConnectionChangedEvent | SyncStatusChangedEvent | SnapshotEvent | LocalChangeEvent<T, P> | RemoteChangeEvent<T, P> | InitializedEvent<P> | WatchedEvent<P> | UnwatchedEvent<P> | PresenceChangedEvent<P> | BroadcastEvent | LocalBroadcastEvent;
...
declare class Document_2<T, P extends Indexable = Indexable> {
     ...
     */
    applySnapshot(serverSeq: bigint, snapshot?: Uint8Array): void;
    /**
     ...
     */
    broadcast(topic: string, payload: Json, options?: BroadcastOptions): void;
}
...
declare class IndexTree<T extends IndexTreeNode<T>> {
     ...
     *
     */
    findLeafPathOfSubTree(subTreePath?: Array<number>): number[];
}
 ...
 */
declare type Json = JsonPrimitive | JsonArray | JsonObject;
...
export declare class Tree {
     ...
     *
     */
    findLeafPathOfSubTree(path: Array<number>): number[] | undefined;
}
...
declare type TRole = 'assistant' | 'user' | 'system';
